namespace AboxDynamicsBase.Classes
{
    public static class AboxServices
    {
        ...
        public const string CrmWebAPILog = "https://aboxcrmapi.aboxplan.com/api/contacts/LogPluginFeedback";
        public const string MainPatientForCaretakerService = "https://apidev.aboxplan.com/member/signup/crm/main";
        public const string MainPatientForTutorService = "https://apidev.aboxplan.com/member/signup/crm/main";
